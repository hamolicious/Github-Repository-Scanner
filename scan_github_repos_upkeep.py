...
#region login
title = fg(Colours.title_colour) + """   _____ _ _   _           _       _    _       _                      _____                                 
  / ____(_) | | |         | |     | |  | |     | |                    / ____|                                
 | |  __ _| |_| |__  _   _| |__   | |  | |_ __ | | _____  ___ _ __   | (___   ___ __ _ _ __  _ __   ___ _ __ 
 | | |_ | | __| '_ \| | | | '_ \  | |  | | '_ \| |/ / _ \/ _ \ '_ \   \___ \ / __/ _` | '_ \| '_ \ / _ \ '__|
 | |__| | | |_| | | | |_| | |_) | | |__| | |_) |   <  __/  __/ |_) |  ____) | (_| (_| | | | | | | |  __/ |   
  \_____|_|\__|_| |_|\__,_|_.__/   \____/| .__/|_|\_\___|\___| .__/  |_____/ \___\__,_|_| |_|_| |_|\___|_|   
                                         | |                 | |                                             
                                         |_|                 |_|                                             """ + reset()
...
def get_data():
    data = [['Repository Name', 'LICENSE', 'README', 'Issues', 'Topics']]
    for repo in repos:
        files = [f.name for f in repo.get_contents('./')]
        data.append([
            repo.name,
            bool_to_sign('LICENSE' in files),
            bool_to_sign('README.md' in files),
            bool_to_sign(repo.get_issues(state='open').totalCount > 0),
            bool_to_sign(len(repo.get_topics()) > 0),
        ])
